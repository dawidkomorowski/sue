...
internal readonly struct Move : IEquatable<Move>
{
    ...
    public bool IsWhiteQueenSideCastling => From is { File: File.E, Rank: Rank.One } && To is { File: File.C, Rank: Rank.One };
    public bool IsBlackKingSideCastling => From is { File: File.E, Rank: Rank.Eight } && To is { File: File.G, Rank: Rank.Eight };
    public bool IsBlackQueenSideCastling => From is { File: File.E, Rank: Rank.Eight } && To is { File: File.C, Rank: Rank.Eight };
